...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/qiyue-pro/auth/components/SmsLoginForm': RouteRecordInfo<'/qiyue-pro/auth/components/SmsLoginForm', '/:uniacid(\\d+)/qiyue-pro/auth/components/SmsLoginForm', Record<never, never>, Record<never, never>>,
